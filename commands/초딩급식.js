  ...
  var d = new Date();
    ...
    if (Object.keys(json['school_infos']).length > 1) {
        ...
        msg.channel.awaitMessages(filter, {
          ...
          .then(msg => {
            ...
            if (msg.content.toUpperCase() == '1' || msg.content.toUpperCase() == '1') {
              const url = 'https://schoolmenukr.ml/api/elementary/' + json['school_infos']['0']['code'] + '?date=' + encodeURI(args[1]);
              ...
              const url = 'https://schoolmenukr.ml/api/elementary/' + json['school_infos']['1']['code'] + '?date=' + encodeURI(args[1]);
      ...
      return
		...
		const url = 'https://schoolmenukr.ml/api/elementary/' + info + '?date=' + encodeURI(args[1]);
